 ...
 */
final class Version20230530100923 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detalle_comanda_bebida (detalle_comanda_id INT NOT NULL, bebida_id INT NOT NULL, INDEX IDX_E1D21567E847589 (detalle_comanda_id), INDEX IDX_E1D21567496D4DC4 (bebida_id), PRIMARY KEY(detalle_comanda_id, bebida_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
